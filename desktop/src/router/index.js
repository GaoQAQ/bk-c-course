...
const questionBank = () => import('@/views/question_bank/question_bank.vue')
const AutoCreat = () => import('@/views/auto_creat/auto_creat.vue')
const SumShow = () => import('@/views/sum_show/sum_show.vue')
const ShowCourse = () => import('@/views/sum_show/show_course.vue')
const StudentShow = () => import('@/views/sum_show/student_show.vue')
