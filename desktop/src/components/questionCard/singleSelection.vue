        ...
        <bk-card title="单选题">
            <bk-form form-type="inline" model="questionData">
                ...
                <bk-form-item>
                    ...
                    <bk-button theme="default" size="small" title="删除" @click="jumpSearch" class="mr10">题库搜索</bk-button>
                </bk-form-item>
            </bk-form>
        </bk-card>
    </div>
...
<script>
    export default {
        ...
        created () {
            /* eslint-disable */
            const { title, option_A, option_B, option_C, option_D, option_E, answer, answer_url, explain, score } = this.answerdata
            this.questionData.title = title
            this.questionData.option_A = option_A
            this.questionData.option_B = option_B
            this.questionData.option_C = option_C
            this.questionData.option_D = option_D
            this.questionData.option_E = option_E
            this.questionData.answer = answer
            this.questionData.answer_url = answer_url
            this.questionData.explain = explain
            this.questionData.score = score
